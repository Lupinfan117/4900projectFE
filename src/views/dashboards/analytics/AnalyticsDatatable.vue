    ...
    >
      ...
      <tbody>
        ...
        >
          ...
          <!-- status -->
          <td v-if="row.rsvp.length>0" v-text="row.rsvp[0].username" />
          <td v-else v-text="'None'" />
          <td  >
              <VIcon
            size="30"
      ...
      >
        <VList>
          ...
          <VDivider class="my-1" />
          <!-- <VListItem @click="edit(row.id)" style="cursor: pointer;">
    ...
    >
        ...
        <VCardText>
         ...
         <VCardText>
          ...
          {{event.rsvp.length>0? event.rsvp[0].username:''}}
        </VCardText>
